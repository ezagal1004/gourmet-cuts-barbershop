                ...
                <div className="mt-12 grid gap-8 lg:grid-cols-3">
                    ...
                    {services.map((svc, index) => (
                        <motion.article
                            ...
                            className="overflow-hidden rounded-2xl border border-white/10 hover:bg-white/[0.03] transition-colors duration-300"
                        >
                            <a
                                href={svc.link}
                                target="_blank"
                    ...
                    <motion.article
                        ...
                        className="rounded-2xl border border-white/10 bg-white/[0.03] hover:bg-white/[0.05] transition-colors duration-300 p-8 sm:p-12 flex flex-col justify-center items-center text-center min-h-[280px]"
                    >
                        <a
